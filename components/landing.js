...
const Landing = () => {
  ...
  return (
    <>
      <div className='d-flex justify-content-center mb-large acordion'>
        <Image onClick={acordion} className={`${open ? 'acordion-icon-open' : 'acordion-icon-close'}`} src={arrow} alt='view more' />
      </div>
      <div className={`acordion-panel ${open ? 'acordion-panel--open' : ''}`}>
